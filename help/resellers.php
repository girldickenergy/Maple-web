...
<html>
    ...
    <div class="full-height-container d-flex flex-column justify-content-center align-items-center text-center" data-aos="fade" data-aos-duration="1000" data-aos-once="true">
        ...
        <div class="info-container text-start mt-4">
            <div class="p-4">
                <h4 class="fw-bold">Officially recognized resellers</h4>
                <ul>
                    <li>Sellix (Credit/debit cards) reseller (AU Timezone +50% fee) - <b>! LasT#0001</b> (Discord ID : <b>890469597524942849</b>)</li>
                    <li>Cryptocurrency reseller (EU Timezone, +20% fee) - <b>Eggsy#6629</b> (Discord ID : <b>883031220454326294</b>)</li>
                </ul>
                ...
                <p>If you think one of our resellers is charging way too much (more than the original amount + their fee), please <a href="contact-us">report this</a> immediately.</p><br>
                <p>Please triple check reseller's discord username, tag and ID before proceeding with the payment.</p>
                <p class="m-0">We are <b>not</b> responsible for scams done by unofficial resellers.</p>
            </div>
        </div>
    </div>
