...
<html>
    <head>
        ...
        <title>Community - Maple</title>
        <meta name="description" content="Join our community Discord server!">
        <meta name="keywords" content="Maple, osu!, community, discord">
    ...
    <body>
    	<div class="w-100 vh-100 d-flex flex-column justify-content-center align-items-center">You're being redirected to Discord...</div>
    </body>
    ...
    <script>
        $(document).ready(function()
        {
            setTimeout(function()
            {
                window.location = "https://discord.gg/P9Yn8FfC2v";
            }, 3000);
        });
    </script>
</html>